...
public class ArchiveJobApplicationEndpoint : IApiEndpoint
{
    ...
    public IEndpointConventionBuilder Register(IEndpointRouteBuilder builder) =>
        builder.MapPatch("/job-applications/{id:guid}/archive", HandleAsync).RequireAuthorization();
        ...
        [AsParameters] Services services)
    {
        ...
        var result = await ArchiveJobApplication.HandleAsync(
            new ArchiveJobApplicationRequest
            {
                Id = parameters.Id,
            },
            userIdResult.Data,
