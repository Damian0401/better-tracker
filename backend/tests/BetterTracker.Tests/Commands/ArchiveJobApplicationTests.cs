...
public class ArchiveJobApplicationTests
{
    private readonly IJobApplicationRepository jobApplicationRepository;

    public ArchiveJobApplicationTests()
    {
    ...
    {
        // Arrange
        var request = new ArchiveJobApplicationRequest
        {
            Id = Guid.NewGuid(),
        };
        ...
        // Act
        var result = await ArchiveJobApplication.HandleAsync(
            request,
            Guid.NewGuid(),
    ...
    [Fact]
    public async Task HandleAsync_ShouldArchiveJobApplication_WhenOwnedByUser()
    {
        // Arrange
        ...
        jobApplication.IsArchived.Should().BeTrue();
    ...
    [Fact]
    public async Task HandleAsync_ShouldReturnSuccessWithoutSaving_WhenAlreadyArchived()
    {
        // Arrange
        var userId = Guid.NewGuid();
        var request = new ArchiveJobApplicationRequest
